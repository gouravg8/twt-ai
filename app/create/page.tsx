...
const page = () => {
  ...
  return (
    <div className='flex flex-col items-center my-16'>
       ...
       <Link href={''} className='bg-[--main-color] w-fit mx-auto text-white px-5 py-2 rounded-full my-5 font-semibold'>Create</Link>

        <div className='w-5/6 my-6 mx-auto border border-dashed px-6'>
            {!isLoaded ? <TweetSkeleton className="mx-auto w-full"/> : (
